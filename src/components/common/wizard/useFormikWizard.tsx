...
const useFormikWizard = ({ activeStepIndex = 0, validateOnNext = true, steps, children, ...props }: WizardProps) => {
  const { currentStepIndex, isPrevDisabled, isFirstStep, isLastStep, handlePrev, handleNext } = useWizard(activeStepIndex, steps, validateOnNext)
  ...
  return {
    ...
    renderComponent: () => <StepComponent {...formik} currentStepIndex={currentStepIndex} />,
  }
}
